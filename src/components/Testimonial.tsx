...
const Testimonials: React.FC = () => {
  ...
  const [editTestimonialId, setEditTestimonialId] = useState<number | null>(
    null
  );
          ...
          <TableBody>
            {testimonials.map((testimonial) => (
              ...
              >
                ...
                <TableCell sx={{ padding: '8px' }}>
                  {testimonial.rating_number}
                </TableCell>
                <TableCell sx={{ padding: '8px' }}>
                  {testimonial.created_at}
                </TableCell>
                <TableCell sx={{ padding: '8px' }}>
                  {testimonial.aprove ? 'Sí' : 'No'}
                </TableCell>
                  ...
                  <IconButton
                    onClick={() =>
                      handleApproveTestimonial(
                        testimonial.id,
                        testimonial.aprove || false
                      )
                    }
                    color={testimonial.aprove ? 'success' : 'default'}
                  >
                    <CheckIcon />
                  </IconButton>
                </TableCell>
